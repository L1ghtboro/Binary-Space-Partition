...
;(function() {
    ...
    $('#discard_label_footnote').click(function(event) {
        ...
        debug("Discard partitions with a w/h or h/w ratio inferior than the\
               defined one. This ugly hack is needed to trick the randomness\
               into giving pleasing looking spaces.. If a partition is too\
               small, it is discarded and a new one is generated until its\
               ratio is on the defined levels")
    })
    initMap()
